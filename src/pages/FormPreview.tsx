...
export default function FormPreview() {
  ...
  const renderField = (field: FormField) => {
    ...
    switch (fieldType) {
      ...
      case "divider":
        return (
          <div key={field.id} className="my-6 border-t border-gray-200">
            {field.label && (
      ...
      case "group":
        return (
          <div key={field.id} className="mb-4 border rounded-lg p-4">
            {field.label && (
              <h3 className="text-sm font-medium mb-3">{field.label}</h3>
            )}
            {field.description && (
